...
import { startOrderConsumers, getRabbitMQChannel } from "./events/rabbitmq.js";
...
export async function buildApp(): Promise<FastifyInstance> {
  ...
  // Start RabbitMQ consumers for payment events
  startOrderConsumers().catch((err) => {
    console.error("[Order App] Failed to start RabbitMQ consumers:", err.message);
  });
